...
namespace PharmacyAssistant
{
    public partial class frmOptions : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            Properties.Settings.Default.CalendarDisplayWeeks = Convert.ToInt32(txtCalendarViewPeriodWeeks.Text);
        ...
        private void LoadSettings()
        {
            ...
            txtCalendarViewPeriodWeeks.Text = Properties.Settings.Default.CalendarDisplayWeeks.ToString();
